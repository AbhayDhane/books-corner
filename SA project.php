...
<head>
    ...
    <title>THE BOOKS CORNER </title>
    <link rel="stylesheet" href="SAstylesheet.css">
...
<body>
    ...
    <section>
        ...
        <div class="main">
            ...
            <div class="main_tag">
                <h1>WELCOME TO<br><span>THE BOOKS CORNER...</span></h1>

                <p>
                    We sell various types of books online in cheap price. <br>
                    We also sell and buy second hand books in 50% off on the books original price.<br>
                    You are welcome   our website.
                   
                </p>
                <a href="#" class="main_btn">Sell</a><br>
                <a href="#" class="_btn">Buy</a>
    ...
    <div class="about">
        ...
        <div class="about_tag">
            <h1>About Us</h1>
            <p>
               Welcome to our book reselling platform, where stories find new homes. At the Books Corner, 
               we  are passionate about connecting readers with affordable, pre loved books. Our journey began
               with a love for literature and a mission to make reading accessible to everyone. Join us in creating a 
               community where books continue to inspire and enrich lives.
        ...
        <div class="featured_book_box">
            ...
            <div class="featured_book_card">
                ...
                <div class="featurde_book_tag">
                    ...
                    <p class="book_price">₹25<sub><del>₹28</del></sub></p>
    ...
    <footer>
        <div class="footer_main">
            ...
            <div class="tag">
                <h1>Contact Info</h1>
                <a href="#"><i class="fa-solid fa-phone"></i>+94 91 122 16901</a>
                <a href="#"><i class="fa-solid fa-phone"></i>+94 32 444 699</a>
                <a href="#"><i class="fa-solid fa-envelope"></i>thebookscorner901@gmail.com</a>
        ...
        <p class="end">Design By<span><i class="fa-solid fa-face-grin"></i> SAIRAJ JADHAV</span></p>
